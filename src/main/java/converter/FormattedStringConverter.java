...
FormattedStringNode.FormatInfo format) {
        if (format.size() > 0) {
...
FormattedStringNode.FormatInfo format) {
    ...
    private void convertToStr(TestNode arg, int start,List<Byte> bytes) {
    ...
    private void convertToRepr(TestNode arg, int start,List<Byte> bytes) {
